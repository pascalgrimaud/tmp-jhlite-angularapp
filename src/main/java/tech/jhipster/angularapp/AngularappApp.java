...
public class AngularappApp {

  private static final Logger log = LoggerFactory.getLogger(AngularappApp.class);

  private static final String SEPARATOR = "----------------------------------------------------------";
  protected static final String LF = "\n";

  public static void main(String[] args) {
    Environment env = SpringApplication.run(AngularappApp.class, args).getEnvironment();
